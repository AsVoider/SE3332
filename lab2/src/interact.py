...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default="./model/output3/0_GPTSingleHead/",
    ...
    def lang_select():
        lang = ""
        while lang not in ["python", "java", "cpp"]:
            print('Enter the programming language you prefer (python or java or cpp)')
            lang = input(">>> ").lower()
        return lang
    ...
    while context != "exit":
        ...
        if lang == "python":
            ...
            input_ids = tokenizer.encode("<java> " + context, return_tensors='pt')
        else:
            input_ids = tokenizer.encode("<cpp> " + context, return_tensors='pt')
